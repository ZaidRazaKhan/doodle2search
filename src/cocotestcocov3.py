...
def main():
    ...
    file_path = '/DATA/khan.2/khan.2/doodle2search/dataset/rendered_256x256/256x256/Sketchy/sketch/tx_000000000000/apple/'
    files = ['n07739125_10025-1.png','n07739125_10025-3.png','n07739125_10069-1.png','n07739125_10135-1.png', 'n07739125_10135-3.png', 'n07739125_10402-2.png']
    # print(type(sketch))
    ...
    print('***Test***')
    for file in files:
        sketch = Image.fromarray(cv2.resize(np.array(Image.open(file_path+file).convert('RGB')), (224, 224)))
