...
class Options():
    ...
    def __init__(self, test=False):
        ...
        # Model parameters
        parser.add_argument('--data_path', '-dp', type=str, default='/DATA/khan.2/khan.2/doodle2search/dataset/', help='Dataset root path.')
        ...
        # parser.add_argument('--load', '-l', type=str, default="/DATA/khan.2/khan.2/logs/29_run-batchSize_10/checkpoint.pth", help='Checkpoint path to resume / test.')
        ...
        parser.add_argument('--exp_idf', type=str,  default='exp_idf', help='Provide an exp_idf for logging purpose.')
